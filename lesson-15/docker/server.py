...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"<b>Hello from: </b> " + socket.gethostname().encode() + b"<br><br>")
        self.wfile.write(b"<b>Interval: </b> " + str(interval).encode() + b"<br><br>")
        self.wfile.write(
            b"<b>Desired count of print: </b> " + str(desired_count).encode() + b"<br><br>"
        )
